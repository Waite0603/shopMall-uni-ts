<template>
  <scroll-view scroll-y class="scroll-view" @scrolltolower="onScrollToLower">
    ...
    <template v-if="userStore.profile">
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              ...
              <label class="radio checkbox"
                ><radio value="r1" :checked="item.selected" @click="onChangeSelect(item)"
              /></label>
              <navigator
      ...
      <!-- 吸底工具栏 -->
      <view class="toolbar" :style="{ paddingBottom: props.bottom + 'px' }">
        <label class="radio all"
          ><radio value="r1" :checked="isSelectAll" @click="onChangeSelectedAll" />全选</label
        >
...
// 接收安全高度, defineProps: withDefaults
...
const selectedCount = computed(() => {
  return selectedList.value.reduce((prev, item) => prev + item.count, 0)
})
