<template>
  <view class="viewport">
    ...
    <view class="form">
      ...
      <!-- 提交按钮 -->
      <button class="form-button" @click="onSubmit">保存</button>
    </view>
  </view>
</template>
...
import { getMemberProfileAPI, putMemberProfileAPI } from '@/api/user'

import type { ProfileDetail, Gender } from '@/types/user'
      ...
      uni.uploadFile({
        ...
        success: (res) => {
          if (res.statusCode === 200) {
            ...
            // 更新 Store 头像
            userStore.profile!.avatar = avatar // [!code ++]
